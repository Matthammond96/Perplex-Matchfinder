<div class="container" style="margin-top: 0px;">
    ...
    <div class="box content">
        ...
        <div class="editor-container">
            ...
            <form method="post" action="<?php $response_region = add_matchfinder_filter($database = 'matchfinder_region'); ?>">
                <input style="width:30%; display:inline-block;" class="form-control" name="display_region" placeholder="Display Name">
                <input style="width:30%; display:inline-block;" class="form-control" name="server_region" placeholder="Server Name (no spacing)">
                <input style="width:30%; display:inline-block;" class="form-control" name="image_region" placeholder="Imagename.jpg">
